...
def buttonClick():
    ...
    roadP = entry1.get()
    label_road_rl_info = Label(root, bg="grey", fg="black",text=roadP)
    label_road_rl_info.grid(row=1, column=3)

def buttonClick2():
    
    roadP1 = entry2.get()
    label_road_gl_info = Label(root,bg="grey",fg="black",text=roadP1)
    label_road_gl_info.grid(row=2,column=3)

def buttonClick3():
    
    roadP2 = entry3.get()
    label_max_road_cap = Label(root,bg="grey",fg="black",text=roadP2)
    label_max_road_cap.grid(row=3,column=3)

def buttonClick4():
    
    roadP3 = entry4.get()
    label_max_veh_pass = Label(root,bg="grey",fg="Black",text=roadP3)
    label_max_veh_pass.grid(row=4,column=3)
...
button1= Button(root,text="Red Light Timer",bg="grey",fg="white", command=buttonClick)
button1.grid(row=1,column=0,ipadx=80)
entry1 = Entry(root,bg="white",fg="black")
entry1.grid(row=1,column=1)

button2= Button(root,text="Green Light Timer",bg="grey",fg="white" , command=buttonClick2)
button2.grid(row=2,column=0,ipadx=80)
entry2 = Entry(root,bg="white",fg="black")
entry2.grid(row=2,column=1)

button3= Button(root,text="Max Capacity",bg="grey",fg="white" , command=buttonClick3)
button3.grid(row=3,column=0,ipadx=80)
entry3 = Entry(root,bg="white",fg="black")
entry3.grid(row=3,column=1)

button4= Button(root,text="Max Pass Per Min",bg="grey",fg="white" , command=buttonClick4)
